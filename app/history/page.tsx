    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {filteredHistory.length === 0 ? (
          <div className="glass p-12 rounded-2xl text-center space-y-4 border border-dashed border-slate-800">
            <div className="w-12 h-12 rounded-full bg-slate-900 flex items-center justify-center mx-auto text-slate-400">
              <History size={20} />
            </div>
            <div>
              <p className="text-sm font-bold text-slate-200">No generations found</p>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="space-y-2 max-w-xl">
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-1 text-[10px] text-slate-550 font-mono">
                ...
                <div className="flex items-center gap-2 self-end md:self-center">
                  ...
                  <button
                    ...
                    className="p-2.5 rounded-xl border border-slate-800 hover:bg-slate-800 text-slate-400 transition-colors"
                    title="Copy Content"
                  >
                    <Copy size={14} />
                  </button>
