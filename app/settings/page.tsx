  ...
  return (
    <div className="max-w-3xl space-y-8">
      ...
      <div className="glass p-6 rounded-2xl border border-slate-800/50 space-y-4">
        <div>
          <h3 className="font-bold text-base text-white">Workspace Presets</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-slate-800 bg-slate-900 text-xs text-slate-100"
            >
      ...
      <div className="glass p-6 rounded-2xl border border-slate-800/50 space-y-5">
        <div>
        ...
        {/* Info banner */}
        <div className="p-4 rounded-xl bg-violet-600/5 border border-violet-500/15 text-xs text-slate-400 leading-relaxed space-y-2">
          <p>
          ...
          <div className="font-mono bg-black/40 p-2.5 rounded-lg border border-slate-800 text-[10px]">
        ...
        <div className="space-y-3">
          ...
          <div className="flex rounded-xl border border-slate-800 overflow-hidden bg-slate-900 p-1 w-full max-w-sm">
            <button
        ...
        {/* Input box override */}
        <form onSubmit={handleSaveKeyOverride} className="space-y-2 pt-2 border-t border-slate-800/50">
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              <input
                ...
                placeholder="AIzaSy..."
                className="w-full pl-4 pr-10 py-2.5 rounded-xl border border-slate-800 bg-slate-900 text-xs focus:outline-none focus:ring-2 focus:ring-violet-500 font-mono text-slate-100"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              className="px-4 py-2.5 rounded-xl text-xs font-bold bg-white text-slate-950 hover:opacity-90 transition-opacity flex items-center gap-1 flex-shrink-0 border border-slate-200/20"
            >
